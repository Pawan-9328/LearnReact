...
const apikey = "9afee456f998243d80aa9ffd95c9ce64";
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const fetchTopRated = async () => {
      const { data: { results },
     } = await axios.get(`${url}/movie/${topRated}?api_key=${apikey}&page=8`)
  ...
  return (
    <section className='home'>
      <div className="banner"  style={{
              backgroundImage: popularMovies[6] ? `url(${`${imgUrl}/${popularMovies[6].poster_path}`})`: "rgb(16, 16, 16)"
      }}>   
